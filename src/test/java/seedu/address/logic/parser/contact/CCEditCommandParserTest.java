...
public class CCEditCommandParserTest {
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        CEditCommand.EditContactDescriptor descriptor = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
    ...
    public void parse_multipleRepeatedFields_acceptsLast() {
        ...
        CEditCommand.EditContactDescriptor descriptor = new EditPersonDescriptorBuilder().withPhone(VALID_PHONE_BOB)
    ...
    public void parse_resetTags_success() {
        ...
        CEditCommand.EditContactDescriptor descriptor = new EditPersonDescriptorBuilder().withTags().build();
        CEditCommand expectedCommand = new CEditCommand(targetIndex, descriptor);
